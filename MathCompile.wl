...
MCLink::workdir="The working directory `1` does not exist.";
MCLink::libdir="The library directory `1` cannot be created.";
...
functionmacro[code_]:=code//.{
    ...
    id["Rescale",p_][any_,list[_][min_,max_]]:>native["rescale",p][any,vargtag,min,max],
    id["Rescale",p_][any_,list[_][min_,max_],list[_][vmin_,vmax_]]:>native["rescale",p][any,vargtag,min,max,vmin,vmax],
