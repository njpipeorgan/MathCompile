...
MathCompile supports linking with external BLAS and LAPACK libraries as an alternative to [Eigen](http://eigen.tuxfamily.org). See this [wiki page] (https://github.com/njpipeorgan/MathCompile/wiki/Guide#external-blas-and-lapack) for how to this.
