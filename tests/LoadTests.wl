...
registertest[test["norm:real",                Function[{Typed[x,{Real,1}]},{Norm[x],Norm[x,1],Norm[x,0+1],Norm[x,1.5],Norm[x,150.0],Norm[x,300]}],{{{-1.,0.,2.,3.,4.,5.}}},Equal]&];
registertest[test["norm:integer",             Function[{Typed[x,{Integer,1}]},N@{Norm[x],Norm[x,2],Norm[x,4.0]}],{{{-3,-3,1,2,3}}},Equal]&];
registertest[test["norm:complex",             Function[{Typed[x,{Complex,1}]},{Norm[x],Norm[x,1],Norm[x,5.5]}],{{RandomComplex[1+I,10]}},Equal]&];
...
registertest[test["standardize:real",         Function[{Typed[x,{Real,2}]},{Standardize[x],Standardize[x,Median],Standardize[x,Median,MedianDeviation]}],{{RandomReal[{-1,1},{6,8}]}},Equal]&];
registertest[test["standardize:integer",      Function[{Typed[x,{Integer,2}]},{Standardize[x],Standardize[x,Median],Standardize[x,Median,MedianDeviation]}],{{RandomInteger[{-10,10},{6,8}]}},Equal]&];
registertest[test["standardize:complex",      Function[{Typed[x,{Complex,2}]},{Standardize[x],Standardize[x,First],Standardize[x,First,Variance]}],{{RandomComplex[1+I,{4,5}]}},Equal]&];
registertest[test["median:integer",           Function[{Typed[x,{Integer,1}]},N@Median[x]],{{RandomInteger[20,10]},{RandomInteger[20,11]},{RandomInteger[20,1]}},Equal]&];
registertest[test["median:real",              Function[{Typed[x,{Real,1}]},Median[x]],{{RandomReal[20,10]},{RandomReal[20,11]},{RandomReal[20,1]}},Equal]&];
registertest[test["median:level2",            Function[{Typed[x,{Real,2}]},Median[x]],{{RandomReal[20,{13,15}]}},Equal]&];
registertest[test["median_deviation:integer", Function[{Typed[x,{Integer,1}]},N@MedianDeviation[x]],{{RandomInteger[20,10]},{RandomInteger[20,11]},{RandomInteger[20,1]}},Equal]&];
registertest[test["median_deviation:real",    Function[{Typed[x,{Real,1}]},MedianDeviation[x]],{{RandomReal[20,10]},{RandomReal[20,11]},{RandomReal[20,1]}},Equal]&];
registertest[test["median_deviation:level2",  Function[{Typed[x,{Real,2}]},MedianDeviation[x]],{{RandomReal[20,{13,15}]}},Equal]&];
registertest[test["mean_deviation:integer",   Function[{Typed[x,{Integer,1}]},N@MeanDeviation[x]],{{RandomInteger[20,10]},{RandomInteger[20,11]},{RandomInteger[20,1]}},Equal]&];
registertest[test["mean_deviation:real",      Function[{Typed[x,{Real,1}]},MeanDeviation[x]],{{RandomReal[20,10]},{RandomReal[20,11]},{RandomReal[20,1]}},Equal]&];
registertest[test["mean_deviation:level2",    Function[{Typed[x,{Real,2}]},MeanDeviation[x]],{{RandomReal[20,{13,15}]}},Equal]&];
registertest[test["threshold:list",           Function[{Typed[x,{Real,1}]},N@{Threshold[x,{"Hard",1.2}],Threshold[x,{"Soft",1.5}],Threshold[x,{"Firm",2.5,0.6,0.5}],Threshold[x,{"PiecewiseGarrote",1.6}],Threshold[x,{"SmoothGarrote",1.8,3}],Threshold[x,{"Hyperbola",1.4}]}],{{RandomReal[{-10,10},100]}},Equal]&];
registertest[test["covariance:real",          Function[{Typed[x,{Real,1}],Typed[y,{Real,1}]},Covariance[x,y]],{{RandomReal[1,10]+Range[10],RandomReal[1,10]+Range[10]}},Equal]&];
registertest[test["covariance:integer",       Function[{Typed[x,{Integer,1}],Typed[y,{Integer,1}]},N@Covariance[x,y]],{{RandomInteger[10,10],RandomInteger[10,10]}},Equal]&];
registertest[test["covariance:complex",       Function[{Typed[x,{Complex,1}],Typed[y,{Complex,1}]},Covariance[x,y]],{{RandomComplex[1+I,10]+Range[10],RandomComplex[1+I,10]+Range[10]}},Equal]&];
registertest[test["covariance:matrix",        Function[{Typed[x,{Integer,2}]},Covariance[x,x]],{{RandomInteger[10,{4,5}]}},Equal]&];
registertest[test["covariance:matrix2",       Function[{Typed[x,{Integer,2}],Typed[y,{Integer,2}]},Covariance[x,y]],{{RandomInteger[10,{4,5}],RandomInteger[10,{4,3}]}},Equal]&];
registertest[test["correlation:real",         Function[{Typed[x,{Real,1}],Typed[y,{Real,1}]},Correlation[x,y]],{{RandomReal[1,10]+Range[10],RandomReal[1,10]+Range[10]}},Equal]&];
registertest[test["correlation:integer",      Function[{Typed[x,{Integer,1}],Typed[y,{Integer,1}]},N@Correlation[x,y]],{{RandomInteger[10,10],RandomInteger[10,10]}},Equal]&];
registertest[test["correlation:complex",      Function[{Typed[x,{Complex,1}],Typed[y,{Complex,1}]},Correlation[x,y]],{{RandomComplex[1+I,10]+Range[10],RandomComplex[1+I,10]+Range[10]}},Equal]&];
registertest[test["correlation:matrix",       Function[{Typed[x,{Integer,2}]},N@Correlation[x,x]],{{RandomInteger[10,{4,5}]}},Equal]&];
registertest[test["correlation:matrix2",      Function[{Typed[x,{Integer,2}],Typed[y,{Integer,2}]},N@Correlation[x,y]],{{RandomInteger[10,{4,5}],RandomInteger[10,{4,3}]}},Equal]&];
registertest[test["inverse:real",             Function[{Typed[x,{Real,2}]},Inverse[x]],{RandomReal[1.0,{#,#}]}&/@{1,3,5},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["inverse:complex",          Function[{Typed[x,{Complex,2}]},Inverse[x]],{RandomComplex[1+I,{#,#}]}&/@{1,3,5},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["inverse:integer",          Function[{Typed[x,{Integer,2}]},N@Inverse[x]],{RandomInteger[10,{#,#}]}&/@{1,3,5},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["linear_solve:real",        Function[{Typed[x,{Real,2}],Typed[y,{Real,1}]},LinearSolve[x,y]],{{RandomReal[1.,{5,5}],RandomReal[1.,{5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["linear_solve:complex",     Function[{Typed[x,{Complex,2}],Typed[y,{Complex,1}]},LinearSolve[x,y]],{{RandomComplex[1+I,{5,5}],RandomComplex[1+I,{5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["linear_solve:integer",     Function[{Typed[x,{Integer,2}],Typed[y,{Integer,1}]},N@LinearSolve[x,y]],{{RandomInteger[100,{5,5}],RandomInteger[100,{5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["least_squares:real",       Function[{Typed[x,{Real,2}],Typed[y,{Real,1}]},LeastSquares[x,y]],{{RandomReal[1.,{5,3}],RandomReal[1.,{5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["least_squares:complex",    Function[{Typed[x,{Complex,2}],Typed[y,{Complex,1}]},LeastSquares[x,y]],{{RandomComplex[1+I,{5,3}],RandomComplex[1+I,{5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["least_squares:integer",    Function[{Typed[x,{Integer,2}],Typed[y,{Integer,1}]},N@LeastSquares[x,y]],{{RandomInteger[100,{5,3}],RandomInteger[100,{5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["pseudo_inverse:real",      Function[{Typed[x,{Real,2}]},PseudoInverse[x]],{{N@{{1,2,3},{4,5,6},{7,8,9}}}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["pseudo_inverse:complex",   Function[{Typed[x,{Complex,2}]},PseudoInverse[x]],{{N@{{1,2,3},{4,5,6},{7,8,9},{3,2,1}}+I}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["geometric_mean:integer",   Function[{Typed[x,{Integer,1}]},N@GeometricMean[x]],{{RandomInteger[10,{100}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["geometric_mean:real",      Function[{Typed[x,{Real,1}]},GeometricMean[x]],{{RandomReal[10,{100}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["geometric_mean:matrix",    Function[{Typed[x,{Real,2}]},GeometricMean[x]],{{RandomReal[10,{10,10}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["lu_decomposition:real",    Function[{Typed[x,{Real,2}]},Module[{lu,p,c},{lu,p,c}=LUDecomposition[x];Join[Flatten@lu,N@p]]],{{RandomReal[1.,{5,5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["lu_decomposition:complex", Function[{Typed[x,{Complex,2}]},Module[{lu,p,c},{lu,p,c}=LUDecomposition[x];Join[Im@Flatten@lu,N@p]]],{{RandomComplex[1+I,{5,5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["cholesky:real",            Function[{Typed[x,{Real,2}]},CholeskyDecomposition[x]],{{#.Transpose[#]&@RandomReal[1.,{5,5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["cholesky:complex",         Function[{Typed[x,{Complex,2}]},CholeskyDecomposition[x]],{{#+ConjugateTranspose[#]+5IdentityMatrix[3]&@RandomComplex[1+I,{3,3}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["schur:real",               Function[{Typed[x,{Real,2}]},Module[{q,t},{q,t}=SchurDecomposition[x];q.t.ConjugateTranspose[q]]],{{RandomReal[1.,{5,5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["schur:complex",            Function[{Typed[x,{Complex,2}]},Module[{q,t},{q,t}=SchurDecomposition[x];q.t.ConjugateTranspose[q]]],{{RandomComplex[1+I,{5,5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
registertest[test["svd:real",                 Function[{Typed[x,{Real,2}]},Module[{u,v,w},{u,v,w}=SingularValueDecomposition[x];u.v.ConjugateTranspose[w]]],{{RandomReal[1.,{5,5}]},{RandomReal[1.,{5,7}]},{RandomReal[1.,{7,5}]}},Max@Abs[#1-#2]<1.*^-6&]&];
